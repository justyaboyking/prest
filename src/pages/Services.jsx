...
const detailedServices = [
  {
    ...
    deepIntel: {
      ...
      risks: [
        ...
        {
          t: 'Gevaar',
          d: 'Ze knagen aan kabels → brandgevaar. Muizen en ratten knagen aan alles — ook aan elektrische kabels.',
      ...
      expandedProtocol: [
        ...
        { t: '2. Interventie', d: 'Op basis van wat we zien kiezen we de juiste aanpak. We werken met professionele middelen in veilige, afgesloten lokdozen — niet bereikbaar voor kinderen of huisdieren.' },
      ...
      <header className={`relative flex flex-col items-center justify-center bg-primary text-white overflow-hidden text-center transition-all duration-700 ${activeService?.heroImage ? 'min-h-[auto] aspect-[3/2] sm:aspect-auto sm:min-h-[75vh] pt-20 sm:pt-48' : 'min-h-[75vh] pt-48 pb-32'}`}>
        <div className="absolute inset-0 z-0">
          <img
            ...
            className={`w-full h-full object-cover transition-all duration-1000 ${activeService?.heroImage ? 'opacity-100 grayscale-0 object-center' : 'opacity-[0.08] grayscale'}`}
          />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 space-y-12">
          ...
          <h1 className="text-6xl md:text-8xl font-display font-black tracking-tighter uppercase leading-[0.85]">
            {activeService ? (
              <>{activeService.title} <br /><span className="text-secondary italic">Wij komen langs en lossen het op.</span></>
            ) : (
              <>
                Onze <br />
          ...
          <p className="text-xl md:text-2xl text-white/80 max-w-4xl mx-auto font-medium leading-relaxed tracking-tight">
            {activeService
