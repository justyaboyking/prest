    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="review-card reveal reveal-up delay-200">
                ...
                <p className="text-slate-600 font-medium italic mb-6">"Ongediertevrij.be heeft ons restaurant gered van een serieuze kakkerlakkenplaag. Hun methode is echt next-level."</p>
                <div className="flex items-center gap-3">
